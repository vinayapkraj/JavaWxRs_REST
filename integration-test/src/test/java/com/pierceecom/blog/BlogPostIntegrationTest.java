...
public class BlogPostIntegrationTest {
    ...
    public void test_1_BlogWithoutPosts() {
        String output = GET(POSTS_URI, 204);
        assertTrue(output.isEmpty());
    }

    @Test
    public void test_2_AddPosts() {
        String location = POST(POSTS_URI + "addPost", POST_1);
        assertEquals(POSTS_URI + "1", location);

        location = POST(POSTS_URI + "addPost", POST_2);
    ...
    private String GET(String uri, int expectedResponseCode) {
        ...
        try {
            ...
            Logger.getLogger(BlogPostIntegrationTest.class.getName()).log(Level.SEVERE, null, ex);
